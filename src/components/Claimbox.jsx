...
import StatementSection from './DropzoneFile';
const Claimbox = () => {
    const {
        register,
        handleSubmit,
...
<div className="bg-white flex flex-col justify-center p-4">
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col items-center gap-6 sm:max-w-md sm:mx-auto">
        ...
        {/* Radio Buttons */}
        <div className="flex flex-col w-full">
            <label>Did you file the claim?</label>
...
<div className="bg-white p-4">
    ...
    <div><StatementSection></StatementSection></div>
</div>
...
<div className="bg-white p-4">
    ...
    <div className='flex flex-col md:flex-row gap-4'><DropZone title={"Upload the contract"}/>
            <DropZone title={"Agreement under Disputes"}/>
    </div>
</div>
...
<div className="bg-white p-4">
    ...
    <div><DropZone title={"Additional Documentation"}/></div>
</div>
